      ...
      <main className="mx-auto max-w-6xl px-6 pb-24 pt-20">
          ...
          <Reveal>
            ...
            >
              <span className="inline-flex items-center gap-1.5 numu-fade-up" style={{ animationDelay: "200ms" }}>
                <ShieldCheck className="h-3.5 w-3.5 text-primary" /> {t("hero.trust.secure")}
              </span>
              <span className="inline-flex items-center gap-1.5 numu-fade-up" style={{ animationDelay: "340ms" }}>
                <Clock3 className="h-3.5 w-3.5 text-primary" /> {t("hero.trust.fast")}
              </span>
              <span className="inline-flex items-center gap-1.5 numu-fade-up" style={{ animationDelay: "480ms" }}>
                <Zap className="h-3.5 w-3.5 text-primary" /> {t("hero.trust.noCC")}
              </span>
            </div>
          </Reveal>
              ...
              <div className="rounded-3xl border-2 border-primary/20 bg-surface-container p-6 shadow-elegant ring-1 ring-inset ring-white/40">
                ...
                <div className="relative mt-6">
                  ...
                  <div className="relative z-10 grid grid-cols-3 items-center">
                    <FlowNode icon={<FileInput className="h-5 w-5" />} label={t("flow.input")} />
                    <FlowNode icon={<Brain className="h-5 w-5" />} label={t("flow.ai")} glow />
                    <FlowNode icon={<FileDown className="h-5 w-5" />} label={t("flow.output")} />
                  </div>
                </div>
        ...
        <section id="misi" className="mt-20 scroll-mt-24">
          <Reveal className="mb-10 max-w-2xl">
            <span className="eyebrow">{t("missions.eyebrow")}</span>
          ...
          {missions.map((m, i) => (
            <Reveal key={m.id} delay={i * 90}>
              <MissionCard
                missionType={m.id}
                icon={m.icon}
                title={m.id === "paper" ? t("missions.paper") : t("missions.presentation")}
            ...
            {[
              ...
              <Reveal key={s.step} delay={i * 100}>
                <div className="bento-card group relative h-full overflow-hidden rounded-3xl p-7 transition-all hover:-translate-y-1">
                  ...
                  <span className="eyebrow relative">{t("how.step")} {s.step}</span>
            ...
            >
              ...
              <div className="relative grid items-center gap-8 md:grid-cols-[1.4fr_1fr]">
                <div>
                  ...
                  <h2 className="mt-3 font-display text-3xl font-semibold md:text-4xl">
                    {t("cta.title")} <span className="underline decoration-white/60 underline-offset-4">{t("cta.titleStrong")}</span>
                  </h2>
