...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Numu AI" },
      { name: "description", content: "Numu AI is an AI-powered productivity platform designed to help students and professionals create high-quality presentations and academic papers automaticall" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Numu AI — AI Workspace untuk Mahasiswa Indonesia" },
      { property: "og:site_name", content: "Numu AI" },
      { property: "og:description", content: "Numu AI is an AI-powered productivity platform designed to help students and professionals create high-quality presentations and academic papers automaticall" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Numu AI — AI Workspace untuk Mahasiswa Indonesia" },
      { name: "twitter:description", content: "Numu AI is an AI-powered productivity platform designed to help students and professionals create high-quality presentations and academic papers automaticall" },
