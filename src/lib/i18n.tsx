...
const translations: Record<Lang, Dict> = {
  id: {
    ...
    "bulk.deleteAll": "Hapus semua proyek",
    "bulk.confirmTitle": "Hapus semua proyek?",
    "bulk.confirmDesc":
      "Tindakan ini akan menghapus {n} proyek beserta jawaban wawancaranya secara permanen dan tidak bisa dibatalkan.",
    "bulk.cancel": "Batal",
    "bulk.confirm": "Ya, hapus semua",
    "bulk.deleting": "Menghapus…",
    "bulk.done": "{n} proyek dihapus",
    "bulk.fail": "Gagal menghapus semua proyek",
    ...
    "profile.planPro": "Paket PRO",
    "profile.planBasic": "Paket Basic",
    "profile.quotaToday": "Kuota hari ini: {used} / {limit} generate",
    "profile.proActive": "Paket PRO aktif sampai {date}. Kuota reset otomatis tiap hari.",
    "profile.basicNote": "Paket Basic dibatasi {basic} generate per hari. Upgrade ke PRO untuk {pro} generate/hari — promo dari Rp100.000 jadi {price}.",
    "profile.upgrade": "Upgrade PRO • {price}",
    "profile.used": "Terpakai {n}",
    "profile.remaining": "Sisa {n} · reset besok",
    "profile.photo": "Foto profil",
    "profile.photoHint": "Pilih avatar bawaan atau unggah foto pribadimu.",
    "profile.upload": "Unggah",
    "profile.uploadPhoto": "Unggah foto",
    "profile.name": "Nama tampilan",
    "profile.university": "Universitas",
    "profile.major": "Jurusan",
    "profile.semester": "Semester",
    "profile.semesterPlaceholder": "Contoh: 5",
    "profile.save": "Simpan perubahan",
    "profile.saved": "Profil disimpan",
    "profile.saveFail": "Gagal menyimpan",
    "profile.signOut": "Keluar",
    "profile.payments": "Riwayat pembayaran",
    "profile.loading": "Memuat…",
    "profile.noPayments": "Belum ada transaksi. Upgrade PRO untuk mulai berlangganan.",
    "profile.proUpgrade": "Upgrade PRO",
    "profile.pay": "Bayar",
    "profile.student": "Mahasiswa",
    "profile.maxSize": "Ukuran maksimum 3MB",
    "profile.photoReady": "Foto siap disimpan. Klik 'Simpan perubahan'.",
    "profile.photoFail": "Gagal memproses foto",
    "profile.noInvoice": "Invoice tidak tersedia",
    "profile.upgradeFail": "Gagal upgrade",
  },
  en: {
    // Header
    "nav.home": "Home",
    ...
    "bulk.deleteAll": "Delete all projects",
    "bulk.confirmTitle": "Delete all projects?",
    "bulk.confirmDesc":
      "This permanently deletes {n} projects along with their interview answers. This cannot be undone.",
    "bulk.cancel": "Cancel",
    "bulk.confirm": "Yes, delete all",
    "bulk.deleting": "Deleting…",
    "bulk.done": "{n} projects deleted",
    "bulk.fail": "Failed to delete all projects",
    ...
    "profile.planBasic": "Basic Plan",
    "profile.quotaToday": "Today's quota: {used} / {limit} generations",
    "profile.proActive": "PRO plan active until {date}. Quota resets automatically every day.",
    "profile.basicNote": "The Basic plan is limited to {basic} generations per day. Upgrade to PRO for {pro} generations/day — promo from Rp100,000 to {price}.",
    "profile.upgrade": "Upgrade PRO • {price}",
    "profile.used": "Used {n}",
    "profile.remaining": "{n} left · resets tomorrow",
    "profile.photo": "Profile photo",
    "profile.photoHint": "Pick a default avatar or upload your own photo.",
    ...
    "profile.major": "Major",
    "profile.semester": "Semester",
    "profile.semesterPlaceholder": "Example: 5",
    ...
    "profile.noPayments": "No transactions yet. Upgrade to PRO to start a subscription.",
    "profile.proUpgrade": "PRO Upgrade",
    "profile.pay": "Pay",
    "profile.student": "Student",
    "profile.maxSize": "Maximum size is 3MB",
    "profile.photoReady": "Photo ready to save. Click 'Save changes'.",
    "profile.photoFail": "Failed to process photo",
    "profile.noInvoice": "Invoice unavailable",
    "profile.upgradeFail": "Upgrade failed",
  },
};
