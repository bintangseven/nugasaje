...
const translations: Record<Lang, Dict> = {
  id: {
    ...
    "mission.undo": "Batalkan jawaban terakhir",

    // Halaman harga
    "pricing.eyebrow": "Harga",
    "pricing.title": "Mulai gratis, naik kelas saat butuh",
    "pricing.promoA": "Promo pembukaan: paket Pro turun dari",
    "pricing.promoB": "jadi cuma",
    "pricing.perMonth": "/bulan",
    "pricing.basic": "Basic",
    "pricing.basicTitle": "Gratis selamanya",
    "pricing.basicDesc": "Cocok buat coba-coba dan tugas ringan.",
    "pricing.basic.f1": "2 submission per hari",
    "pricing.basic.f2": "Akses kedua misi (Makalah & PPT)",
    "pricing.basic.f3": "Riwayat proyek tersinkron",
    "pricing.basic.f4": "Unduh .docx & .pptx",
    "pricing.startFree": "Mulai gratis",
    "pricing.promoBadge": "Promo 50%",
    "pricing.proTitle": "Buat yang serius",
    "pricing.proDesc": "Untuk minggu UTS, UAS, dan revisi dosen yang nggak ada habisnya.",
    "pricing.pro.f1": "10 submission per hari",
    "pricing.pro.f2": "Prioritas antrian generate",
    "pricing.pro.f3": "Preview PPT & Makalah in-app",
    "pricing.pro.f4": "Riwayat & ekspor tanpa batas",
    "pricing.pro.f5": "Dukungan via WhatsApp",
    "pricing.proActive": "PRO aktif",
    "pricing.until": "s.d.",
    "pricing.preparing": "Menyiapkan pembayaran…",
    "pricing.upgrade": "Upgrade ke Pro",
    "pricing.activeNote": "Paket kamu masih aktif. Kamu bisa upgrade lagi setelah masa berlaku habis.",
    "pricing.alreadyProUntil": "Kamu sudah PRO — aktif sampai {date}.",
    "pricing.alreadyPro": "Kamu sudah PRO aktif.",
    "pricing.invoiceFail": "Gagal membuat invoice",

    // Halaman FAQ
    "faq.eyebrow": "FAQ",
    "faq.title": "Pertanyaan yang sering ditanya",
    "faq.subtitle": "Belum ketemu jawabannya? Kirim pesan lewat menu Profil.",
    "faq.q1": "Apakah hasilnya bisa diedit?",
    "faq.a1": "Bisa. File .docx bisa dibuka di Word/Google Docs, dan .pptx bisa diedit di PowerPoint, Keynote, atau Canva. Semua isi bebas kamu ubah.",
    "faq.q2": "Apakah hasilnya akan terdeteksi AI?",
    "faq.a2": "Kami menyusun struktur dan kalimat ala mahasiswa, bukan hasil mentah model. Tapi tetap baca ulang, tambahkan referensi pribadi, dan sesuaikan gaya kamu sendiri sebelum dikumpulkan.",
    "faq.q3": "Bagaimana kalau hasilnya kurang sesuai?",
    "faq.a3": "Kamu bisa ulangi dengan brief yang lebih spesifik (tambah outline, gaya bahasa, atau lampirkan PDF referensi). Tiap submission gratis di paket Basic dan murah di Pro.",
    "faq.q4": "Apakah datanya aman?",
    "faq.a4": "Brief, jawaban, dan hasilmu hanya bisa diakses oleh akunmu sendiri. Lihat halaman kebijakan privasi untuk detail penyimpanan dan retensi.",
    "faq.q5": "Bagaimana cara upgrade ke Pro?",
    "faq.a5": "Masuk ke menu Profil dan tekan Upgrade. Selama masa promo, paket Pro hanya Rp50.000/bulan dengan 10 submission/hari.",
    "faq.q6": "Bisa dipakai untuk skripsi/jurnal?",
    "faq.a6": "Bisa untuk bab pendukung, ringkasan, dan kerangka. Untuk karya akhir, gunakan sebagai asisten — referensi dan analisis utama tetap perlu kamu validasi.",
  ...
  en: {
    ...
    "mission.undo": "Undo last answer",

    // Pricing page
    "pricing.eyebrow": "Pricing",
    "pricing.title": "Start free, upgrade when you need it",
    "pricing.promoA": "Launch promo: the Pro plan drops from",
    "pricing.promoB": "to just",
    "pricing.perMonth": "/month",
    "pricing.basic": "Basic",
    "pricing.basicTitle": "Free forever",
    "pricing.basicDesc": "Great for trying things out and light assignments.",
    "pricing.basic.f1": "2 submissions per day",
    "pricing.basic.f2": "Access to both missions (Paper & Slides)",
    "pricing.basic.f3": "Synced project history",
    "pricing.basic.f4": "Download .docx & .pptx",
    "pricing.startFree": "Start free",
    "pricing.promoBadge": "50% off",
    "pricing.proTitle": "For serious work",
    "pricing.proDesc": "For midterms, finals, and endless lecturer revisions.",
    "pricing.pro.f1": "10 submissions per day",
    "pricing.pro.f2": "Priority generation queue",
    "pricing.pro.f3": "In-app slide & paper preview",
    "pricing.pro.f4": "Unlimited history & exports",
    "pricing.pro.f5": "WhatsApp support",
    "pricing.proActive": "PRO active",
    "pricing.until": "until",
    "pricing.preparing": "Preparing payment…",
    "pricing.upgrade": "Upgrade to Pro",
    "pricing.activeNote": "Your plan is still active. You can upgrade again once it expires.",
    "pricing.alreadyProUntil": "You are already PRO — active until {date}.",
    "pricing.alreadyPro": "You already have an active PRO plan.",
    "pricing.invoiceFail": "Failed to create invoice",

    // FAQ page
    "faq.eyebrow": "FAQ",
    "faq.title": "Frequently asked questions",
    "faq.subtitle": "Still not answered? Send us a message from the Profile menu.",
    "faq.q1": "Can the results be edited?",
    "faq.a1": "Yes. The .docx opens in Word/Google Docs and the .pptx is editable in PowerPoint, Keynote, or Canva. Everything is yours to change.",
    "faq.q2": "Will the output be flagged as AI?",
    "faq.a2": "We build student-style structure and sentences, not raw model output. Still, reread it, add your own references, and adjust the tone before submitting.",
    "faq.q3": "What if the result is not quite right?",
    "faq.a3": "Run it again with a more specific brief (add an outline, tone, or attach a reference PDF). Submissions are free on Basic and cheap on Pro.",
    "faq.q4": "Is my data safe?",
    "faq.a4": "Your briefs, answers, and results are only accessible from your own account. See the privacy policy for storage and retention details.",
    "faq.q5": "How do I upgrade to Pro?",
    "faq.a5": "Open the Profile menu and press Upgrade. During the promo, Pro is only Rp50,000/month with 10 submissions per day.",
    "faq.q6": "Can I use it for a thesis or journal?",
    "faq.a6": "Yes for supporting chapters, summaries, and outlines. For final work, treat it as an assistant — you still need to validate the key references and analysis.",
